...
<?php echo $error ?>
    <form action="index.php" method="post">
        ...
        <table id="rounded-corner">
            ...
            <tr><th>PIB:</th><th><?php echo $klijent->getPIB();?><input type="hidden" name="ime" value="<?php echo $klijent->getPIB();?>"/></th></tr>
             <tr><th>Naziv:</th><th><?php echo $klijent->getNaziv();?><input type="hidden" name="prezime" value="<?php echo $klijent->getNaziv();?>"/></th></tr>
               <tr><th>Adresa:</th><th><?php echo $klijent->getAdresa();?><input type="hidden" name="adresa" value="<?php echo $klijent->getAdresa();?>"/></th></tr>
                 <tr><th>Telefon:</th><th><?php echo $klijent->getTelefon();?><input type="hidden" name="telefon" value="<?php echo $klijent->getTelefon();?>"/></th></tr>
                   <tr><th>E-mail:</th><th><?php echo $klijent->getEmail();?><input type="hidden" name="email" value="<?php echo $klijent->getEmail();?>"/></th></tr>
                    <tr><th>Fax:</th><th><?php echo $klijent->getFax();?><input type="hidden" name="email" value="<?php echo $klijent->getFax();?>"/></th></tr>
                   <tr><th>Izaberi uslugu:</th><th>
